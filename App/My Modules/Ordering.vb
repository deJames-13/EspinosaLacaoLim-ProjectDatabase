...
Public Class Ordering
    ...
    Public Sub MakeOrder()
        ...
        Try
            Dim id As String = GetLastId("order") + 1
            Dim query As String =
            $"
            ...
            VALUES
            (LAST_INSERT_ID(), {product("id")}, {quantity}, {product("price") * quantity}, 'pending');
            "
    ...
    Public Sub UpdateOrder()
        ...
        $"
            ...
            UPDATE `order_has_product` SET quantity = {quantity}, cost = {product("price") * quantity}
